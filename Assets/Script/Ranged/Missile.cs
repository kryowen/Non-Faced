...
public class Missile : MonoBehaviour
{
    ...
    void Move()
    {
        ...
        {
            /*
            if(range.animator.GetInteger("isMoving").Equals(1))
            {
                moveVelocity = Vector3.left;
            }

            else if (range.animator.GetInteger("isMoving").Equals(2))
            {
                moveVelocity = Vector3.right;
            }

            else if (range.animator.GetInteger("isMoving").Equals(3))
            {
                moveVelocity = Vector3.up;
            }

            else if (range.animator.GetInteger("isMoving").Equals(4))
            {
