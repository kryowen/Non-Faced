...
public class Boss_Missile : MonoBehaviour
{
    ...
    void Move()
    {
        ...
        {
            /*
            if(boss.animator.GetInteger("isMoving").Equals(1))
            {
                moveVelocity = Vector3.left;
            }

            else if (boss.animator.GetInteger("isMoving").Equals(2))
            {
                moveVelocity = Vector3.right;
            }

            else if (boss.animator.GetInteger("isMoving").Equals(3))
            {
                moveVelocity = Vector3.up;
            }

            else if (boss.animator.GetInteger("isMoving").Equals(4))
            {
